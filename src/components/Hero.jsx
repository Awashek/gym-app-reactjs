  ...
  return (
    ...
    text-center max-w-[800px] w-full mx-auto p-4'>
        <div className='flex flex-col gap-4'>
            <p>GET UP AND WORKOUT</p>
            <h1 className='uppercase font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-7xl'>
                GET<span className='text-blue-400'>BIGGER</span>
            </h1>       
        </div>
        <p className='text-sm md:text-base font-light'>I hereby acknowledgement that I may become 
            <span className='text-blue-400 font-medium'> unbelievably bigger </span> 
        ...
        border-[2px] bg-slate-950 border-blue-400 border-solid
        blueShadow duration-200'><p>Accept and Begin</p></button>
    </div>
  )
}
